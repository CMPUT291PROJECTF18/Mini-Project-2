...
copyright = '2018, Nathan Klapstein, Thomas Lorincz'
...
man_pages = [
    (master_doc, 'mini-project-2', 'mini-project-2 Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mini-project-2', 'mini-project-2 Documentation',
     author, 'mini_project_2', "CMPUT291PROJECTF18 mini project 2",
     'Miscellaneous'),
]
